...
You can try it just through installing a pinned file and running it in python terminal or another code redactor.

UPD: The project is in beta, so it could contain bugs or feel unfinished
